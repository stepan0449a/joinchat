...
<head>
    ...
    <!--====== TITLE TAG ======-->
    <title>JoinChat - Чат бот для аптеки и продажи фармацевтики</title>
                        ...
                        <div class="row">
                            <div class="col-md-12 flex-v-center">
                                ...
                                <div class="header-call-to-action hidden-sm hidden-xs hidden-md">
                                    <a href="https://app.joinchat.us/ru/signup" target="_blank" class="action-button main-action">Попробовать бесплатно</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-6 col-xs-6">
                                    <div class="single-process-box xs-mb50 wow fadeInLeft viber" data-wow-delay="0.3s">
                                      <a href="viber://pa/info?uri=demojoinfarmacy" target="_blank">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-6">
                                    <div class="single-process-box xs-mb50 wow fadeInLeft telegram" data-wow-delay="0.6s">
                                      <a href="https://t.me/demojoinfarmacy_bot" target="_blank">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="single-process-box hidden-sm wow fadeInLeft web" data-wow-delay="0.9s">
                                      <a href="https://app.joinchat.us/" target="_blank">
                                        ...
                                        <p> <!--Логин: pharmacy1@amemory.pro<br> Пароль: 123123--></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5  col-lg-5 col-sm-12 col-xs-12">
                            <div class="area-content">
                                ...
                                <div class="text-icon-box wow fadeInRight" data-wow-delay="0.6s">
                                    <p>Здоровье — один из важнейших элементов жизни каждого человека. Кто то болеет и у него нет возможности пойти в аптеку. Кому то нельзя пропустить не один прем препарата, потому что это жизненно важно. При создании данного бота мы учли на сколько эта важно для каждого пользователя. Данный бот позволит вашим клиентам быть ближе к вам, напомнит им о приеме препарата и о заканчивающихся запасах с возможностью заказа в любой момент..</p>
                                    <a href="https://app.joinchat.us/ru/signup" target="_blank" class="read-more active add-adaptive">Попробовать бесплатно</a>
