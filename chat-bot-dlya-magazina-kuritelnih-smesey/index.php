...
<head>
    ...
    <!--====== TITLE TAG ======-->
    <title>JoinChat - Чат бот для продажи табачных изделий</title>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="area-content xs-center xs-mb50">
                            ...
                            <h1>Бот для магазина табачных изделий</h1>
                            <ul class="no-padding">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-6 col-xs-6">
                                    <div class="single-process-box xs-mb50 wow fadeInLeft viber" data-wow-delay="0.3s">
                                      <a href="viber://pa/info?uri=demojointobacco" target="_blank">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-6">
                                    <div class="single-process-box xs-mb50 wow fadeInLeft telegram" data-wow-delay="0.6s">
                                      <a href="https://t.me/demojointobacco_bot" target="_blank">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="single-process-box hidden-sm wow fadeInLeft web" data-wow-delay="0.9s">
                                      <a href="https://app.joinchat.us/" target="_blank">
                                        ...
                                        <p><!--Логин: tobacco@amemory.pro<br> Пароль: 123123--></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5  col-lg-5 col-sm-12 col-xs-12">
                            <div class="area-content">
                                ...
                                <div class="text-icon-box wow fadeInRight" data-wow-delay="0.6s">
                                    <p>Основной аудиторией которая покупает вєйпы и курительные смеси является молодежь. С данным чат ботом у вас получится попасть туда, где они проводят большую часть своего времени, а именно в чаты. Пользователи данного бота смогут в пару кликов заказать себе нужны товар. Помимо этого у вас появится возможность рассылки с акциями и скидками. Ваши пользователи всегда будут в курсе нововведений вашего магазина.</p>
