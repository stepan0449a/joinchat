...
<head>
    ...
    <!--====== TITLE TAG ======-->
    <title>JoinChat - Чат бот для продажи цифровой техники</title>
                        ...
                        <div class="row">
                            <div class="col-md-12 flex-v-center">
                                ...
                                <div class="header-call-to-action hidden-sm hidden-xs hidden-md">
                                    <a href="https://app.joinchat.us/ru/signup" target="_blank" class="add-adaptive action-button">Попробовать бесплатно</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="area-content xs-center xs-mb50">
                            ...
                            <h1>Бот для магазина цифровой техники</h1>
                            <ul class="no-padding">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-6 col-xs-6">
                                    <div class="single-process-box xs-mb50 wow fadeInLeft viber" data-wow-delay="0.3s">
                                      <a href="viber://pa/info?uri=demojointech" target="_blank">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-6">
                                    <div class="single-process-box xs-mb50 wow fadeInLeft telegram" data-wow-delay="0.6s">
                                      <a href="https://t.me/demojointechnology_bot" target="_blank">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="single-process-box hidden-sm wow fadeInLeft web" data-wow-delay="0.9s">
                                      <a href="https://app.joinchat.us/" target="_blank">
                                        ...
                                        <p><!--Логин: ct@amemory.pro<br> Пароль: 123123--></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5  col-lg-5 col-sm-12 col-xs-12">
                            <div class="area-content">
                                ...
                                <div class="text-icon-box wow fadeInRight" data-wow-delay="0.6s">
                                    <p>Данный чат предназначен оформления заказов в для магазина цифровой техники. Это будет интересным нововведением в вашем бизнесе. Вы сможете быть в чате с каждым пользователем и помощью рассылки подогревать интерес к вашей компании. Теперь, все пользователи будут осведомлены о предстоящих акциях и нововведениях.</p>
                                    <a href="https://app.joinchat.us/ru/signup" target="_blank" class="main-action read-more active">Попробовать бесплатно</a>
