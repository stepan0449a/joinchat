...
<head>
    ...
    <!--====== TITLE TAG ======-->
    <title>JoinChat - Чат бот для рыболовов</title>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="area-content xs-center xs-mb50">
                            ...
                            <h1>Бот для магазина рыбалки</h1>
                            <ul class="no-padding">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-6 col-xs-6">
                                    <div class="single-process-box xs-mb50 wow fadeInLeft viber" data-wow-delay="0.3s">
                                      <a href="viber://pa/info?uri=demojoinfish" target="_blank">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-6">
                                    <div class="single-process-box xs-mb50 wow fadeInLeft telegram" data-wow-delay="0.6s">
                                      <a href="https://t.me/demojoinfish_bot " target="_blank">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="single-process-box hidden-sm wow fadeInLeft web" data-wow-delay="0.9s">
                                      <a href="https://app.joinchat.us/" target="_blank">
                                        ...
                                        <p><!--Логин: fish@amemory.pro<br> Пароль: 123123--></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5  col-lg-5 col-sm-12 col-xs-12">
                            <div class="area-content">
                                ...
                                <div class="text-icon-box wow fadeInRight" data-wow-delay="0.6s">
                                    <p>Ваши клиенты заядлые рыболовы и им не где общаться? Данный чат бот ответит на множество часто задаваемых вопросов как справочник, помимо этого у клиентов вашего магазина появится возможность заказать необходимые им товары удаленно. Они будут в курсе ваших акций, новых товаров и нововведений. Благодаря тому что вы постоянно с ними, у них отпадет нужда в поиске новых магазинов с схожими услугами.</p>
