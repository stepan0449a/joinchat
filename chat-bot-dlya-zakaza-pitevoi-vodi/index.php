...
<head>
    ...
    <!--====== TITLE TAG ======-->
    <title>JoinChat - Чат бот для продажи питьевой воды</title>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="area-content xs-center xs-mb50">
                            ...
                            <h1> Бот для заказа питьевой воды</h1>
                            <ul class="no-padding">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-6 col-xs-6">
                                    <div class="single-process-box xs-mb50 wow fadeInLeft viber" data-wow-delay="0.3s">
                                      <a href="viber://pa/info?uri=demojoinwaterbot" target="_blank">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-6">
                                    <div class="single-process-box xs-mb50 wow fadeInLeft telegram" data-wow-delay="0.6s">
                                      <a href="https://t.me/demojoinwater_bot" target="_blank">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="single-process-box hidden-sm wow fadeInLeft web" data-wow-delay="0.9s">
                                      <a href="https://app.joinchat.us/" target="_blank">
                                        ...
                                        <p><!--Логин: water@amemory.pro <br> Пароль: 123123--></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5  col-lg-5 col-sm-12 col-xs-12">
                            <div class="area-content">
                                ...
                                <div class="text-icon-box wow fadeInRight" data-wow-delay="0.6s">
                                    <p> Во многих городах нет доступа к питьевой воде. Многим приходится ее покупать. Искать вас в поисковике и оформлять заказ не всем удобно и затратно по времени. Данный бот стане дополнением к вашему сайту. Он сам может оформить заказ, также реализована подписка в ходе которой поставки воды осуществляются автоматически через определенный промежуток времени выбираемый пользователем. Так как вы находитесь в чате с каждым клиентом у вас появится возможность рассылки. Это будет интересным нововведением для молодой аудитории клиентов. Больше не нужно искать клиентов, мы сделали что бы они сами искали вас и успешно находили.</p>
