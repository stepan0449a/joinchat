...
<head>
    ...
    <!--====== TITLE TAG ======-->
    <title>JoinChat - Чат бот для продажи растений</title>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="area-content xs-center xs-mb50">
                            ...
                            <h1>Бот для магазина растений</h1>
                            <ul class="no-padding">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-6 col-xs-6">
                                    <div class="single-process-box xs-mb50 wow fadeInLeft viber" data-wow-delay="0.3s">
                                      <a href="viber://pa/info?uri=demojoinplants" target="_blank">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-6">
                                    <div class="single-process-box xs-mb50 wow fadeInLeft telegram" data-wow-delay="0.6s">
                                      <a href="https://t.me/demojoinplants_bot" target="_blank">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="single-process-box hidden-sm wow fadeInLeft web" data-wow-delay="0.9s">
                                      <a href="https://app.joinchat.us/" target="_blank">
                                        ...
                                        <p><!--Логин: homeflow@amemory.pro<br> Пароль: 123123--></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5  col-lg-5 col-sm-12 col-xs-12">
                            <div class="area-content">
                                ...
                                <div class="text-icon-box wow fadeInRight" data-wow-delay="0.6s">
                                    <p>Как часто в ваш магазин заходят покупатели? Данный бот даст вам возможность находить покупателей каждый день, а не только по праздникам. Бот станет другом для каждого пользователя, который подскажет как часто поливать их цветы, напомнит о поливе, какое удобрение лучше использовать для определенного вида. Когда клиент решит приобрести новое растение, он будет обращаться к вам, как магазину который заботится о своих покупателях и как к другу который посоветует. Клиенты которые дарят цветы, тоже не обделены функционалом. У них появится возможность заказа удаленно и доставки. С помощью этого бота вы закроете все зоны потенциальных клиентов и привлечете молодую категорию клиентов.</p>
