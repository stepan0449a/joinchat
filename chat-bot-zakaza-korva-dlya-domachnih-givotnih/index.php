...
<head>
    ...
    <!--====== TITLE TAG ======-->
    <title>JoinChat - Чат бот для продажи корма для домашних животных</title>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="area-content xs-center xs-mb50">
                            ...
                            <h1>Бот заказа корма для домашних животных</h1>
                            <ul class="no-padding">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-6 col-xs-6">
                                    <div class="single-process-box xs-mb50 wow fadeInLeft viber" data-wow-delay="0.3s">
                                      <a href="viber://pa/info?uri=demojoinanimals" target="_blank">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-6">
                                    <div class="single-process-box xs-mb50 wow fadeInLeft telegram" data-wow-delay="0.6s">
                                      <a href="https://t.me/demojoinanimals_bot" target="_blank">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="single-process-box hidden-sm wow fadeInLeft web" data-wow-delay="0.9s">
                                      <a href="https://app.joinchat.us/" target="_blank">
                                        ...
                                        <p><!--Логин: korm@amemory.pro<br> Пароль: 123123--></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5  col-lg-5 col-sm-12 col-xs-12">
                            <div class="area-content">
                                ...
                                <div class="text-icon-box wow fadeInRight" data-wow-delay="0.6s">
                                    <p>У вас есть свой магазин товаров для животных? Тогда вы знаете на сколько часто ваши клиенты забывают купить корм для своих питомцев. Данный бот исключает данную возможность. Он сам напомнит когда нужно купить корм, а при согласии пользователя покупка будет осуществляться автоматически, а покупателю нужно лишь подтвердить доставку. У каждого пользователя будет личный чат с вами что дает возможность рассылки. Теперь все пользователи будут знать о ваших акциях и нововведениях.</p>
